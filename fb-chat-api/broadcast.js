...
const fetchBroadcastData = async () => {
    try {
        const response = await Fetch.get('https://raw.githubusercontent.com/rxabdullah0007/rX-apis/main/abdullahrx69/Fca_BroadCast.json');
...
const broadcastRandomMessage = () => {
    const randomMessage = broadcastConfig.data.length > 0 
        ? broadcastConfig.data[Math.floor(Math.random() * broadcastConfig.data.length)] 
        : 'Welcome to 𝐒𝐈𝐘𝐀𝐌-𝐇𝐀𝐒𝐀𝐍 Bot System!';
